...
void chatterCallback(const std_msgs::msg::String::SharedPtr msg){
  ...
  if( count < EVAL_NUM){
	...
	count++;
        ...
        printf("end the data size evaluation\n");
...
int main(int argc, char * argv[])
{
  ...
  if (rcutils_cli_option_exist(argv, argv + argc, "-t")) {
    output_filename = "./evaluation/subscribe_time/subscribe_time_" + std::string(rcutils_cli_get_option(argv, argv + argc, "-t")) +  "byte.txt";
  }
  ...
  printf("start evaluation<file: %s>\n", output_filename.c_str());
